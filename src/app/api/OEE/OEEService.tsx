...
const OEEService = {
    async GetOEEByMonth(month : string, idMaquina: string): Promise<ApiResponse<number>> {
      try {
    ...
    async GetDisponibilidadeByMonth(month : string, idMaquina: string): Promise<ApiResponse<number>> {
        try {
          const { data } = await dashApi.get<ApiResponse<number>>
      ...
      async GetQualidadeByMonth(month : string, idMaquina: string): Promise<ApiResponse<number>> {
        try {
          const { data } = await dashApi.get<ApiResponse<number>>
      ...
      async GetPerformanceByMonth(month : string, idMaquina: string): Promise<ApiResponse<number>> {
        try {
          const { data } = await dashApi.get<ApiResponse<number>>
