...
const ManutencaoService = {
    ...
    async GetMTTRMonth(month : string, idMaquina: string): Promise<ApiResponse<number>> {
      try {
        const { data } = await dashApi.get<ApiResponse<number>>
    ...
    async GetMTBFMonth(month : string, idMaquina: string): Promise<ApiResponse<number>> {
      try {
        const { data } = await dashApi.get<ApiResponse<number>>
